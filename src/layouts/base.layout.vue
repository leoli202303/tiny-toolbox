      ...
      <div class="sider-content">
        ...
        <div class="footer">
          <div>
            ...
            <c-link target="_blank" rel="noopener" :href="`https://artiversehub.ai`">
              Artiversehub-AI Art Generator
            </c-link>

            <template v-if="commitSha && commitSha.length > 0">
              -
              <c-link target="_blank" rel="noopener" type="primary" :href="`https://animegirl.studio`">
                AnimeGirl.Studio
              </c-link>
            </template>
          </div>
    ...
    <template #content>
      <div flex items-center justify-center gap-2>
        ...
        <c-tooltip position="bottom" :tooltip="$t('home.support')">
          <c-button
            round
            href="https://www.buymeacoffee.com/artiversehub"
            rel="noopener"
            target="_blank"
